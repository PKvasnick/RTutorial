...
%Fix @ifundefined behaviour / should go away with an update of caption pkg
\makeatletter
...
\clearpage \input{RTutorial_Remote.tex} \clearpage
\clearpage \input{RTutorial_Uvod.tex} \clearpage
\clearpage \input{RTutorial_R.tex} \clearpage
